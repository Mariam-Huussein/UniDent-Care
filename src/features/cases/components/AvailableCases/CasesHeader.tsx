...
export default function CasesHeader({ totalCases, showingCases, viewMode, setViewMode }: CasesHeaderProps) {
    return (
        <div className="relative z-10 rounded-2xl sm:rounded-3xl bg-white border border-gray-100 shadow-xl shadow-gray-100/50 p-5 sm:p-8 mb-6 sm:mb-8 overflow-hidden">
                ...
                <div className="flex items-center gap-3 self-start md:self-auto ml-13 md:ml-0 flex-wrap">
                    ...
                    <div className="flex bg-gray-100 p-1 rounded-xl shrink-0">
                        <button
                            ...
                            className={`flex items-center justify-center px-3 py-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-white text-indigo-600 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-200'}`}
                            title="Grid View"
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center justify-center px-3 py-2 rounded-lg transition-all ${viewMode === 'table' ? 'bg-white text-indigo-600 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-200'}`}
                            title="Table View"
                        >

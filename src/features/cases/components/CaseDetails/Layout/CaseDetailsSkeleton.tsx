            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl border border-gray-100/80 shadow-sm p-5 sm:p-6 lg:p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
                    ...
                    <div className="space-y-3">
                        <div className="aspect-square lg:aspect-4/3 rounded-2xl bg-linear-to-br from-gray-100 to-gray-50" />
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-gray-100 to-gray-200" />
